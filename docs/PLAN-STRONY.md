...
- **Etap 6 — Zaufanie i konwersja:** zaimplementowany i wdrożony (2026-07-15, na wyraźne polecenie „commit etap 6”). `/wyniki`, `/cennik`, `/opinie`, `/o-nas`, `/kontakt`. Lista pytań do właściciela (historia firmy, zespół, cena par, czas lekcji) pozostaje otwarta — placeholdery na `/o-nas` widoczne na żywo do czasu uzupełnienia. Szczegóły, audyt danych: `docs/STATUS.md`.
